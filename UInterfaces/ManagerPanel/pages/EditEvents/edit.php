				...
				<html>
                    ...
                    <div class="form-group">
					 ...
					 // confirm that the 'id' value is a valid integer before getting the form data
						 ...
						 $eventsTitle = mysqli_real_escape_string(htmlspecialchars($_POST['eventsTitle']));
						 
						 $eventsDetails = mysqli_real_escape_string(htmlspecialchars($_POST['eventsDetails']));
						 $eventsDate = mysqli_real_escape_string(htmlspecialchars($_POST['eventsDate']));
						 $eventsTime = mysqli_real_escape_string(htmlspecialchars($_POST['eventsTime']));
					 ...
					 $result = mysqli_query($connection, "SELECT * FROM events WHERE eventsID=$eventsID")
					 or die(mysqli_error()); 
