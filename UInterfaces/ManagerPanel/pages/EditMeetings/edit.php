				...
				<html>
                    ...
                    <div class="form-group">
					 ...
					 // confirm that the 'id' value is a valid integer before getting the form data
						 ...
						 $meetingsTitle = mysqli_real_escape_string(htmlspecialchars($_POST['meetingsTitle']));
						 
						 $meetingsDetails = mysqli_real_escape_string(htmlspecialchars($_POST['meetingsDetails']));
						 $meetingsDate = mysqli_real_escape_string(htmlspecialchars($_POST['meetingsDate']));
						 $meetingsTime = mysqli_real_escape_string(htmlspecialchars($_POST['meetingsTime']));
						 $duration = mysqli_real_escape_string(htmlspecialchars($_POST['duration']));
						 $users = mysqli_real_escape_string(htmlspecialchars($_POST['users']));
					 ...
					 $result = mysqli_query($connection, "SELECT * FROM meetings WHERE meetingsID=$meetingsID")
					 or die(mysqli_error()); 
