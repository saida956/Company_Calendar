				...
				<html>
                    ...
                    <div class="form-group">
					 ...
					 // confirm that the 'id' value is a valid integer before getting the form data
						 ...
						 $start = mysqli_real_escape_string(htmlspecialchars($_POST['start']));
						 $due = mysqli_real_escape_string(htmlspecialchars($_POST['due']));
						 $description = mysqli_real_escape_string(htmlspecialchars($_POST['description']));
						 $manager = mysqli_real_escape_string(htmlspecialchars($_POST['manager']));
						 $members = mysqli_real_escape_string(htmlspecialchars($_POST['members']));
						 $progress = mysqli_real_escape_string(htmlspecialchars($_POST['progress']));
						 ...
						 // check that firstname/lastname fields are both filled in
								 ...
								 else
								 {
										 ...
										 mysqli_query($connection, "UPDATE task SET taskTitle='$title', description='$description' , startDate ='$start', dueDate='$due', manager='$manager', members='$members', Progress=$progress WHERE taskID='$taskID'")
										 or die(mysqli_error()); 
					 ...
					 // query db
					 $taskID = $_GET['id'];
					 $result = mysqli_query($connection, "SELECT * FROM task WHERE taskID=$taskID")
					 or die(mysqli_error()); 
